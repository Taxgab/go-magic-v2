  ...
  const columns = [
    {
      ...
      render: (profesor: Profesor) => (
        <span className="font-medium text-on-surface">{profesor.nombre}</span>
      ),
    },
    {
      key: 'especialidad',
      header: 'Especialidad',
      render: (profesor: Profesor) => (
        <span className="text-on-surface-variant">{profesor.especialidad || '-'}</span>
      ),
    },
    {
      key: 'comision',
      header: 'Comisión',
      render: (profesor: Profesor) => (
        <span className="text-on-surface-variant">{profesor.porcentaje_comision}%</span>
      ),
    },
    {
      key: 'telefono',
      header: 'Teléfono',
      render: (profesor: Profesor) => (
        <span className="text-on-surface-variant">{profesor.telefono || '-'}</span>
      ),
    },
    {
      key: 'estado',
